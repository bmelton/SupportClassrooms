...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'directors_director', (
        ...
        db.send_create_signal(u'directors', ['Director'])


    def backwards(self, orm):
        # Deleting model 'Director'
        db.delete_table(u'directors_director')


    models = {
        u'directors.director': {
