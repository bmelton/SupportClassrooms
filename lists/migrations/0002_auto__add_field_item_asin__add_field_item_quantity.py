...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.asin'
        db.add_column(u'lists_item', 'asin',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.quantity'
        db.add_column(u'lists_item', 'quantity',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.asin'
        db.delete_column(u'lists_item', 'asin')

        # Deleting field 'Item.quantity'
        db.delete_column(u'lists_item', 'quantity')
