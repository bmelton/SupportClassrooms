...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MasterItem.name'
        db.alter_column(u'lists_masteritem', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'MasterItem.name'
        db.alter_column(u'lists_masteritem', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))
